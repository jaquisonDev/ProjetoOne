...
export const Companies = () => {
  ...
  const verifyMenuOption = () => {
    showMenuOption ? setShowMenuOption(false) : setShowMenuOption(true);
  };
      ...
      <C.ContainerExpenseEx>
        ...
        <C.AreaLogo secondary>
          ...
          <span className="text-logo">
            ...
            controlando seus fluxos como: cadastrar, atualizar, buscar e
            excluir.
          </span>
        </C.AreaLogo>
        ...
        <C.FormularyEx onSubmit={(e) => e.preventDefault()}>
          ...
          <C.Inputs
            type="text"
            placeholder="Produto(descrição - opcional)..."
          />
